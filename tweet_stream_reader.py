...
#get each tweet Language and the count of its appearance(not to be confused with programming language)
...
ax1.set_ylabel('Tweet Languages', fontsize=15)
